...
#
#       speed_in_inches_per_second = 83.3 * speed_in_degrees_per_second + 0
#
...
# DONE: Write the code necessary to make the robot drive at that speed going roughly that distance.
