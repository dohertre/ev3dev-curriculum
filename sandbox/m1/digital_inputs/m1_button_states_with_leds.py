...
def main():
    ...
    while True:
        ...
        if btn.up:
            ...
            down_button_presses = down_button_presses + 1
            if down_button_presses == 1:
                while btn.down:
                    ev3.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.GREEN)
                    ev3.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.GREEN)
                    time.sleep(0.01)
            if down_button_presses == 2:
                while btn.down:
                    ev3.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.RED)
                    ev3.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.RED)
                    time.sleep(0.01)
            if down_button_presses == 3:
                while btn.down:
                    ev3.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.AMBER)
                    ev3.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.AMBER)
                    time.sleep(0.01)
            if down_button_presses == 4:
                while btn.down:
                    ev3.Leds.all_off()
                    time.sleep(0.01)
            if down_button_presses == 5:
                down_button_presses = 0
